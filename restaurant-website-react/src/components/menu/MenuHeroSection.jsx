  ...
  return (
    <section className="relative bg-gradient-to-br from-cream-dark via-cream-hero to-cream-darker py-16 lg:py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-primary-dark rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-6 sm:px-6 lg:px-16 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="font-display text-5xl lg:text-6xl xl:text-7xl text-primary mb-4 leading-tight">
            Our Complete Menu
          </h1>
          <p className="text-primary-dark text-lg lg:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="max-w-3xl mx-auto">
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-5 text-base lg:text-md border-0 focus:ring-0 focus:outline-none bg-transparent placeholder-gray-400"
                  />
                  {searchTerm && (
                    <button
            ...
            <div className="my-6 flex flex-wrap items-center justify-center gap-3">
              <span className="text-primary-dark text-sm">Popular:</span>
              {["Breakfast", "Noodles", "Salads", "Japanese"].map((tag) => (
                <button
                  key={tag}
                  onClick={() => setActiveCategory(tag.toLowerCase())}
                  className="px-4 py-2 bg-primary-dark/20 hover:bg-primary-dark/30 backdrop-blur-sm text-black text-sm rounded-full border border-primary-dark/30 transition-all hover:scale-105"
                >
                  {tag}
                </button>
              ))}
