...
import { Briefcase, Gift, Smartphone } from "lucide-react";
  ...
  const specialServices = [
    {
      ...
      description:
        "Professional catering solutions for business meetings, conferences, and corporate events.",
      image:
    ...
    },
    {
      ...
      title: "Gift Vouchers",
      description:
        "Give the gift of great food with our customizable restaurant gift vouchers.",
      image:
    ...
    },
    {
      ...
      title: "Mobile App",
      description:
        "Order seamlessly through our user-friendly mobile app with exclusive app-only deals.",
      image:
