        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 xl:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2 relative group">
            ...
            <div className="relative">
              ...
              <img
                ...
                className="relative rounded-full w-full max-w-md lg:max-w-sm xl:max-w-lg mx-auto shadow-2xl z-10 border-8 border-white group-hover:scale-105 transition-transform duration-500"
              />
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="font-sans font-bold text-3xl sm:text-5xl lg:text-5xl xl:text-6xl text-dark leading-tight">
                We Are More Than Just <br className="hidden sm:block" />
                <span className="text-primary">Multiple Services</span>
              </h2>
              <p className="text-dark-gray text-sm sm:text-lg leading-relaxed max-w-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {services.map((service, idx) => (
                <div
                  key={idx}
                  className="group flex items-start gap-4 p-3 rounded-2xl bg-cream-light/30 hover:bg-white hover:shadow-xl hover:border-primary/20 border-2 border-transparent transition-all duration-300"
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-xl shadow-md flex items-center justify-center group-hover:bg-primary group-hover:scale-110 transition-all duration-300 flex-shrink-0">
                    <service.icon className="w-5 h-5 sm:w-6 sm:h-6 text-primary group-hover:text-white" />
                  </div>
                  <div>
                    <h4 className="font-bold text-dark text-xs sm:text-sm mb-1 group-hover:text-primary transition-colors">
                      {service.title}
                    </h4>
                    <p className="text-dark-gray text-[10px] sm:text-xs font-medium">
                      {service.desc}
                    </p>
                  </div>
                </div>
            ...
            <div className="flex gap-4 pt-2">
              <Link to="/about">
                <button className="group bg-primary text-xs sm:text-base text-white hover:bg-primary-dark px-6 lg:px-8 xl:px-10 py-3 lg:py-3 rounded-2xl font-bold transition-all shadow-xl hover:shadow-primary/30 hover:scale-105 flex items-center gap-2">
                  Learn About Us
