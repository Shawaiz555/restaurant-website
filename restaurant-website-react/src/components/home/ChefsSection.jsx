  ...
  const chefs = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1583394293214-28ded15ee548?w=400&h=500&fit=crop",
    },
    {
      name: "Esther Howard",
      image:
      ...
      <div className="container mx-auto px-3 sm:px-6 lg:px-10 xl:px-16">
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="flex gap-2">
            <button className="swiper-button-prev-chefs w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-cream border-2 border-dark/10 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white transition-all">
              ←
            </button>
            <button className="swiper-button-next-chefs w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary text-white flex items-center justify-center hover:bg-primary-dark transition-all">
              →
            </button>
          </div>
        </div>
