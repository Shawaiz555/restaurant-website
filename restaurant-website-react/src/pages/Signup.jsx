        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 sm:p-12">
            <button
              ...
              className="block w-full text-center my-2 text-dark-gray hover:text-dark transition-colors"
            >
              ← Back to Home
            </button>
            <button
            ...
            <h2 className="font-display text-3xl lg:text-4xl tracking-wide text-center mb-2">
              Sign Up
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-dark-gray mt-1 ml-1">
